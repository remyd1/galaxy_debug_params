...
var GalaxyMenu = Backbone.Model.extend(
{
    ...
    create: function()
    {
       ...
       if (this.options.user.valid) //add the following menu if user is not a guest
            {
            //
            // Parameters tab.
            //
            ...
            var parameters_options = {
                ...
                title       : "Parameters",
                content     : "parameters",
                title_attribute : 'Accessible histories'
            }

            var tab_parameters = new mod_masthead.GalaxyMastheadTab(parameters_options);
            ...
            tab_parameters.add({
                title       : "Display history parameters",
                content     : "parameters/history_parameters?full_screen=False",
                target      : "_frame"
            });
            tab_parameters.add({
                title       : "Display history parameters - reverse order",
                content     : "parameters/history_parameters?reverse_order=True&amp;full_screen=False",
                target      : "_frame"
            });
            tab_parameters.add({
                title       : "History parameters as XML",
                content     : "parameters/history_parameters?as_xml=True",
                target      : "_frame"
            });
            tab_parameters.add({
                title       : "Download parameters",
                content     : "parameters/history_parameters?as_xml=True&amp;to_ext=True",
                target      : "_frame"
            });

            this.masthead.append(tab_parameters);
            ...
            if (this.options.is_admin_user)
                ...
                var tab_debug = new mod_masthead.GalaxyMastheadTab(debug_options);

                tab_debug.add({
                    title       : "Debug available histories",
                    content     : "parameters",
                    target      : "_frame",
                    divider : true
                });
                tab_debug.add({
                    title       : "Debug command lines",
                    content     : "parameters/command_lines?full_screen=False",
                    target      : "_frame"
                });
                tab_debug.add({
                    title       : "Debug command lines - reverse_order",
                    content     : "parameters/command_lines?reverse_order=True&amp;full_screen=False",
                    target      : "_frame"
                });
                tab_debug.add({
                    title       : "Generate Shell script",
                    content     : "parameters/command_lines?full_screen=False&amp;to_ext=True",
                    target      : "_frame"
                });

                this.masthead.append(tab_debug);
                }
            }
